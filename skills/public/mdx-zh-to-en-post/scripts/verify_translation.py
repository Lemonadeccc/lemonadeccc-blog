...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate translated MDX structure for zh->en workflow.")
    parser.add_argument("--source", required=True, help="Path to source Chinese MDX/MD file.")
    parser.add_argument("--target", required=True, help="Path to target English MDX/MD file.")
